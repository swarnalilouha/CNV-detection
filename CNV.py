## Script for dtetection of CNV's in th genome by simulation of read depth across the genome using a gaussian distribution. The script also filters out genomic regionswith very high read depths to correct for biases.
#!/usr/bin/env python
